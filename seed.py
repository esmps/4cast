...
user1 = User.signup(first_name="Emma", last_name="Pines", email="emma.pines.s@gmail.com", password="test123", home_location="Santa Clara, CA", c_or_f="C")
user2 = User.signup(first_name="Emma", last_name="Schwartz", email="test@test.com", password="test123", home_location="Oakland, CA", c_or_f="F")
